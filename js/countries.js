...
const chang_country_element = document.querySelector(".change-country");
...
chang_country_element.addEventListener("click",function(){
    input.value = "";
    resetCountryList();
...
//Reset all and show all the country
